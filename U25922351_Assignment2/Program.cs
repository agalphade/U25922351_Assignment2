    ...
    class Program
    {
        ...
        public static IList<int> MoveZeroes(int[] nums)
        {
            try
            {
                ...
                for (int j = 0; j < nums.Length; j++)
                {
                    if (nums[j] != 0)
                    {
                        // Swap non-zero element with the element at pointer i
                        int temp = nums[i];
                        nums[i] = nums[j];
                        nums[j] = temp;
                ...
                // Create a list containing the modified array
        ...
        */
        ...
        public static int BinaryToDecimal(int binary)
        {
            ...
            {
                int decimalValue = 0;
                int baseValue = 1; // Represents the base value of each binary digit
                ...
                while (binary != 0)
                {
                    ...
                    baseValue *= 2; // Binary is base 2, so each digit position represents a power of 2
                }
        ...
        */
        ...
        public static int MaximumGap(int[] nums)
        {
            try
            {
                ...
                int minGap = Math.Max(1, (maxVal - minVal) / (n - 1));
                ...
                bool[] filled = new bool[numBuckets];

                for (int i = 0; i < n; i++)
                {
                    int bucketIndex = (nums[i] - minVal) / minGap;
        ...
        */
        ...
        public static int LargestPerimeter(int[] nums)
        {
            try
            {
                ...
                Array.Sort(nums, (a, b) => b.CompareTo(a)); // Sort in non-increasing order

                for (int i = 0; i < nums.Length - 2; i++)
                {
                    if (nums[i] < nums[i + 1] + nums[i + 2]) // Check if triangle inequality holds
                    {
        ...
        */
        ...
        public static string RemoveOccurrences(string s, string part)
        {
            try
            {
                ...
                while (index != -1)
                {
                    s = s.Remove(index, part.Length); // Remove the part
                    index = s.IndexOf(part); // Find the next occurrence
                }
